...
["middleware0"]=`echo $inventory | jq '.middleware.hosts[0]'` \
["middleware_asap"]=`echo $inventory | jq '.middleware_asap.hosts[0]'` \
["middleware_realtime"]=`echo $inventory | jq '.middleware_realtime.hosts[0]'` \
["middleware_pipeline"]=`echo $inventory | jq '.middleware_pipeline.hosts[0]'` \
